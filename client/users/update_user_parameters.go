...
func (o *UpdateUserParams) WithBody(body *models.UserPartial) *UpdateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user params
func (o *UpdateUserParams) SetBody(body *models.UserPartial) {
	o.Body = body
}
