...
func (o *DeleteUserBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /users/{id}][%d] deleteUserBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteUserDefault) Error() string {
	return fmt.Sprintf("[DELETE /users/{id}][%d] deleteUser default  %+v", o._statusCode, o.Payload)
}
